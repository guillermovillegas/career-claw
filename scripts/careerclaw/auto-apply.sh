...
You are applying for Jane Doe to this job (already saved in the tracker, job_id: ${JOB_ID}).
...
One more concrete proof point, then a clean close. End with just: Jane Doe
