...
function buildPrompt(title, company, mode) {
  return `Write a 100-140 word cover letter. Applicant: Jane Doe. Role: ${title} at ${company} (${mode}).
...
- P2: One more relevant proof point (different from P1). End with "Jane Doe" on its own line.
